...
// POST /api/spy/ads/[id]/approve-concept — create image_job from approved proposal
export async function POST(
  ...
  if (adErr || !ad) {
    return safeError(adErr ?? new Error("Not found"), "Spy ad not found", 404);
  }
