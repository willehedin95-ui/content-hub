...
// POST /api/spy/ads/[id]/generate-concepts — AI concept generation from spy ad
export async function POST(
  ...
  // Fetch product + guidelines (same pattern as /api/swipe/route.ts)
  ...
  const userPrompt = buildConceptUserPrompt(ad, count);
