  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl px-4 py-3 mb-6">
        <p className="text-amber-300 text-sm font-medium">Recommended: Use environment variables</p>
        <p className="text-amber-400/70 text-xs mt-0.5">
          For security, set these as environment variables in your Vercel project settings instead of storing them here. See <code className="bg-amber-500/10 px-1 rounded">.env.local.example</code> for the variable names.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 text-sm text-slate-400 hover:text-slate-200 border border-[#1e2130] px-4 py-2.5 rounded-lg transition-colors"
          >
            {showKeys ? (
...
function Section({
  ...
  return (
    <div className="bg-[#141620] border border-[#1e2130] rounded-xl p-5 space-y-4">
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full bg-[#0a0c14] border border-[#1e2130] text-slate-200 placeholder-slate-600 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-indigo-500 font-mono"
      />
    </div>
  );
}
