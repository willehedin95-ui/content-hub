  ...
  return (
    ...
    >
      ...
      >
            ...
            {isOriginal && onReroll && sourceImage.generation_style && (
              <div className="flex items-center gap-0.5 ml-1">
                ...
                <button
                  ...
                  title="Re-roll with custom instructions"
                >
        ...
        {/* Re-roll with instructions panel */}
        {showRerollInstructions && isOriginal && onReroll && (
          <div className="px-5 py-3 border-t border-gray-100 shrink-0 bg-indigo-50/30">
            <textarea
              value={rerollText}
              onChange={(e) => setRerollText(e.target.value)}
              placeholder={'e.g. "Change badge text to \'Prova 30 dagar - 249 kr\'" or "Make the background warmer"'}
              rows={2}
              className="w-full text-xs border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300 resize-none bg-white"
              autoFocus
            />
